  ...
  const handleApplyPatch = async () => {
    ...
    if (response === 0) {
      try {
        ...
        setActionStatus('Change application started in terminal')
      } catch (err) {
